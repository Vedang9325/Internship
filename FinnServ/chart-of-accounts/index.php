...
// Redirect if there's no active company context
...
<head>
    ...
    <title>Chart of Accounts | FinnServ</title>
...
<div class="gateway-app">
    ...
    <!-- Top navigation bar & keyboard shortcuts -->
    ...
    <!-- Page / active company context titlebar -->
    ...
    <main class="company-menu-page">
        <section class="company-menu-panel">
            <div class="company-menu-title">Chart of Accounts</div>

            <div class="company-menu-list">
                <a href="<?= BASE_URL ?>groups/" class="company-menu-item">Groups</a>
                <a href="#" class="company-menu-item disabled">Ledgers</a>
            </div>
