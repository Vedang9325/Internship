...
// Clear validation cache immediately so old errors don't persist on page refreshes.
unset($_SESSION['financial_year_errors']);
unset($_SESSION['financial_year_old']);
...
<div class="page-header">
    ...
    <div>
        ...
        <p>
            Create a new accounting period for your company.
        </p>
...
<div class="card">
    ...
    <form
        action="<?= BASE_URL ?>financial-year/save.php"
        method="POST"
    >
