    ...
    <main class="company-menu-page">
        <section class="company-menu-panel">
            ...
            <div class="company-menu-list">
                <a href="<?= BASE_URL ?>groups/create.php" class="company-menu-item">Create</a>
                <a href="#" class="company-menu-item disabled">Alter</a>
                <a href="<?= BASE_URL ?>groups/display.php" class="company-menu-item">Display</a>
                <a href="#" class="company-menu-item disabled">Delete</a>
            </div>
            <div class="company-menu-footer">
                <a href="<?= BASE_URL ?>chart-of-accounts/" class="company-menu-back">← Back to Chart of Accounts</a>
            </div>
        </section>
    </main>
