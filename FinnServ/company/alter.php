...
unset($_SESSION['company_alter_errors']);

unset($_SESSION['company_alter_old']);


/*
|--------------------------------------------------------------------------
| Use Previously Submitted Data If Available
|--------------------------------------------------------------------------
*/
...
<div class="gateway-app">
    ...
    <main class="company-form-page">
        ...
        <form
            action="<?= BASE_URL ?>company/update.php"
            method="POST"
            class="company-form"
        >
